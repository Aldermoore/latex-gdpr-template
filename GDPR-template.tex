...
\newcommand{\dato}{ \today }							% Skriv dato for dataindsamlingen, eller behold som \today for dags dato

\newcommand{\opgavebeskrivelse}{
% Skriv beskrivelsen af projektet og hvilke data der indsamles og til hvilket formål
